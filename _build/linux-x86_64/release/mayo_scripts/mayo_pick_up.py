...
# world settings
my_world = World(stage_units_in_meters=0.3937)
my_world.scene.add_default_ground_plane()
#my_world.get_physics_context().set_gravity(-385.827)

# set up OR scene
nuc_path = "omniverse://10.10.51.5"
stage_path = "/home/ubuntu/or_scenes/OR_test3.usd"
add_reference_to_stage(usd_path=stage_path, prim_path="/World/OR")
